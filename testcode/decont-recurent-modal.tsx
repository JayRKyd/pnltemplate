...
interface DecontRecurentModalProps {
  isOpen: boolean;
  onClose: () => void;
  onSave?: (data: any) => void;
}

export function DecontRecurentModal({ isOpen, onClose, onSave }: DecontRecurentModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      {/* Modal */}
      <div className="relative bg-white rounded-2xl shadow-xl w-full max-w-[700px] mx-4">
        {/* Header */}
...
export default DecontRecurentModal;
